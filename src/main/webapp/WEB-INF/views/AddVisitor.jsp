       ...
       <div class="nen">
    	...
    	<section class="section dashboard" style="color:black;">
			<form action="saveuser" method="post">
				Visitor Category Id: <input type="text" name="Visitor Category Id"> <br><br>
				 House Id: <input type="text" name=" HouseId"> <br><br> 
	             ...
	             Profile Pic: <input type="text" name="ProfilePic"> <br><br>
	             Entry Time: <input type="text" name=" EntryTime"> <br><br>
	             Exit Time: <input type="text" name="ExitTime"> <br><br>
